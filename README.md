...
3. Отправьте файл `xhc.log` в [Issues](https://github.com/elthebestdevelopman-cyber/XiaoHyperCleaner/issues)
...
См. [чек-лист в Releases](https://github.com/elthebestdevelopman-cyber/XiaoHyperCleaner/releases) для детального чек-листа.
...
Полный текст: [creativecommons.org/licenses/by-nc/4.0](https://creativecommons.org/licenses/by-nc/4.0/)
