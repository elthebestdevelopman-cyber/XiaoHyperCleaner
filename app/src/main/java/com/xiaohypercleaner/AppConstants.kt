...
/**
 * Константы приложения для настройки таймаутов, задержек и параметров подключения.
 */
object AppConstants {
    /** ADB параметры подключения */
    ...
    /** Таймауты обнаружения портов */
    const val PORT_DISCOVERY_TIMEOUT_MS = 3000L

    /** Таймауты UI операций */
    ...
    /** Задержки между командами и повторными попытками */
