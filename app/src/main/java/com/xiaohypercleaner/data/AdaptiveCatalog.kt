...
object AdaptiveCatalog {
    ...
    /**
     * Полный сброс состояния синглтона (каталог + кэши) — только для тестов.
     *
     * isLoaded/catalogJson переживают смену контекста: без сброса один
     * тест-класс может «отравить» синглтон для другого (загрузив каталог
     * из mock-контекста с null-ассетами: isLoaded=true, catalogJson=null).
     */
